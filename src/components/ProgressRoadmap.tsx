...
import { Trophy, CheckCircle2, ChevronRight, Star } from 'lucide-react';
...
export const ProgressRoadmap = ({ lang, currentLevel }: ProgressRoadmapProps) => {
  ...
  return (
    <div className={`bg-white rounded-[2.5rem] p-8 md:p-12 border border-slate-200 shadow-sm overflow-hidden relative ${isRtl ? 'font-arabic' : 'font-sans'}`} dir={isRtl ? 'rtl' : 'ltr'}>
          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              <h4 className="text-xl font-black text-[#002147]">
                {isRtl ? `أنت تبلي بلاءً حسناً في ${levels[currentIndex].label}!` : `You're doing great in ${levels[currentIndex].label}!`}
              </h4>
